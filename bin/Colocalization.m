function [OUTPUTT]= Colocalization(SPOTS,varargin)
%%%%ISS NNN creates the Nearest Neighbor Network

%If image analyzed is not specified, first image is selected as default 
if nargin==1
imagesel=1;
else
 imagesel=varargin{2}
end
Colocalization_number_neighbors=SPOTS.Colocalization_number_neighbors;
disp('Colocalization calculation is starting. Note that it can take several hours...');
