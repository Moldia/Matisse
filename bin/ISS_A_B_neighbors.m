...
function []=ISS_A_B_neighbors(SPOTS,transcript)

%% compare relative closeness of A and B to any other transcript
%  Xiaoyan 2014-11-17 / SMS2020
...
idx_A = find(strcmp((transcript(1)),name_uni));
idx_B = find(strcmp((transcript(2)),name_uni));
...
name_test = find(strcmp((transcript(1)),name_uni));
