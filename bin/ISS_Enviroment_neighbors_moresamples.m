...
% Xiaoyan, 2017
function[OUTPUT] =ISS_Enviroment_neighbors_moresamples(SUPEROBJECT,radius)
...
distx=20;%90
disty=20;%200%Number of pca components. Must be between number of samples and number of genes includeda
...
[inbin, bincenters,iName] = hexbin_near_spots(pos, hexagon_radius,distx,disty,iName);
